...
playerName = "Not as stupid random" 

# Enter your own player description, e.g. what kind of strategy has been used.
playerDescription = "Moves are chosen randomly but the same one is not chosen twice."
...
def chooseMove():
    ...
    row=3
    col=3
    while not(opponentBoard[row][col]==const.EMPTY):
